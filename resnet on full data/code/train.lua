...
function Trainer:train(epoch, dataloader)
   ...
   for n, sample in dataloader:run() do
      ...
      print((' | Epoch: [%d][%d/%d]    Time %.3f  Data %.3f  Err %1.4f  top1 %7.3f  top5 %7.3f'):format(
         epoch, n, trainSize, timer:time().real, dataTime, loss,100 - top1, top5))
    ...
    file:write(100 - top1Sum / N.."\n")
    file_loss:write(lossSum / N.."\n")
...
function Trainer:test(epoch, dataloader)
   ...
   for n, sample in dataloader:run() do
      ...
      local loss = self.criterion:forward(self.model.output, self.target)
      totalLoss = totalLoss + loss*batchSize
      ...
      print((' | Test: [%d][%d/%d]    Time %.3f  Data %.3f  top1 %7.3f (%7.3f)  top5 %7.3f (%7.3f)'):format(
         epoch, n, size, timer:time().real, dataTime, 100 - top1, 100 - top1Sum / N, top5, top5Sum / N))
